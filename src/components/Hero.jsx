...
const Hero = () => {
  ...
  return (
    <section id="hero" className="relative z-10 min-h-[100svh] w-full overflow-hidden">
      <div className="video-wrapper absolute inset-0 z-0 w-full h-full bg-black">
        {isMobile ? (
          <img
...
//     videoRef.current.onloadedmetadata = () => {
//       videoRef.current.play(); // Avoid animating currentTime on mobile
//     };
//   }, []);
